...
var PROPS = {
  ...
  button:      [{ key: "name", label: "名称", kind: "text" }, { key: "text", label: "文本", kind: "text" },
                { key: "color", label: "外观色", kind: "color" },
                { key: "x", label: "X", kind: "number" }, { key: "y", label: "Y", kind: "number" },
                { key: "w", label: "宽", kind: "number" }, { key: "h", label: "高", kind: "number" }],
  slider:      [{ key: "name", label: "名称", kind: "text" }, { key: "color", label: "外观色", kind: "color" },
  ...
  switch:      [{ key: "name", label: "名称", kind: "text" }, { key: "color", label: "外观色", kind: "color" },
                { key: "x", label: "X", kind: "number" },
